...
def eval_pinn_performace(domain, binary_config, max_iters, mode, device):
    
    if binary_config.ndim == 2:
        binary_config = binary_config.squeeze()
        
    pinn_config = pinn_binary_decoder(binary_config)
